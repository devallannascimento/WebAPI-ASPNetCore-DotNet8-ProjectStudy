        ...
        public async Task<IActionResult> Register([FromBody] RegisterModelDTO model)
        {
            ...
            if (userExists != null)
            {
                return StatusCode(
                    ...
                    new ResponseDTO { StatusCode = "Error", Message = "User already exists!" }
                    );
            }
            ...
            if (!result.Succeeded)
            {
                return StatusCode(
                    StatusCodes.Status500InternalServerError,
                    new ResponseDTO { StatusCode = "Error", Message = "User creation failed!" }
                    );
            }

            return Ok(new ResponseDTO { StatusCode = "Success", Message = "User created successfully!" });
        }
